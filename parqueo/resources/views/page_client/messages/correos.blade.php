                    ...
                    <div class="card-body">
                        ...
                        <div class="ps-3 border-0">
                            ...
                            <div class="row mb-5 mt-3 justify-content-center">
                                ...
                                <div class="col-md-4 ">
                                    <a class="btn btn-primary bg-blue-dark" href="{{ url('/client/conversations') }}">
                                        Cancelar
                                    </a>
                                </div>
                                <div class="col-md-4">
            ...
            <x-slot name="content" class="">
                ...
                <div class="content-chat position-relative">
                    ...
                    <div class="footer-chat position-absolute pe-3">
                        <hr class="m-0">
                        <form class="bg-white" action="{{route('conversation_emails.store_client')}}" method="POST" enctype="multipart/form-data">
                            @csrf
