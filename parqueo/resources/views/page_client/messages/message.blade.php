            ...
            <div class="col-8 col-md-8 col-lg-7">
                ...
                <div class="content-chat position-relative">
                    ...
                    <div class="footer-chat position-absolute pe-3">
                        <hr class="m-0">
                        <form class="bg-white" action="{{route('send_conversation_message_client')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row justify-content-center ">
                                <div class="col-4">
                                    <a href="{{url('/client/conversations')}}" class="btn btn-primary bg-blue-dark"> Cerrar </a>
                                </div>
                            </div>
                        </form>
                    </div>
