    ...
    <div class="container">
        <div class="row justify-content-center pt-5">
            <div class="col-md-8 col-lg-7">
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="ps-3" method="POST" action="{{ route('cargo.store') }}">
                            @csrf
                            <div class="row mb-3">
                                <label for="nom_cargo" class="col-md-4 col-form-label">Nombre</label>

                                <div class="col-md-6">
                                    <input id="nom_cargo" type="text"
                                           class="form-control @error('nom_cargo') is-invalid @enderror" name="nom_cargo"
                                           value="" required autocomplete="nom_cargo" autofocus>
