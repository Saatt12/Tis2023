    ...
    <div class="container">
        <div class="row justify-content-center pt-5">
            <div class="col-md-8 col-lg-7">
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="ps-3" method="POST" action="{{ route('unidad.store') }}">
                            @csrf
                            <div class="row mb-3">
                                <label for="nom_unidad" class="col-md-4 col-form-label">Nombre</label>

                                <div class="col-md-6">
                                    <input id="nom_unidad" type="text"
                                           class="form-control @error('nom_unidad') is-invalid @enderror" name="nom_unidad"
                                           value="" required autocomplete="nom_unidad" autofocus>
